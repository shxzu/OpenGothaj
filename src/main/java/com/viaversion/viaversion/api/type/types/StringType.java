...
extends Type<String> {
    ...
    public String read(ByteBuf buffer) throws Exception {
        ...
        Preconditions.checkArgument(len <= this.maxLength * MAX_CHAR_UTF_8_LENGTH, "Cannot receive string longer than Short.MAX_VALUE * " + MAX_CHAR_UTF_8_LENGTH + " bytes (got %s bytes)", new Object[]{len});

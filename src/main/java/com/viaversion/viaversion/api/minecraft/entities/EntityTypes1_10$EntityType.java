...
public enum EntityTypes1_10$EntityType implements EntityType
{
    ENTITY(-1),
    ...
    private static final Map<Integer, EntityTypes1_10$EntityType> TYPES;
    private final int id;
    private final EntityTypes1_10$EntityType parent;

    private EntityTypes1_10$EntityType(int id) {
        this.id = id;
        this.parent = null;
    }

    private EntityTypes1_10$EntityType(int id, EntityTypes1_10$EntityType parent) {
        this.id = id;
        this.parent = parent;
    }
    ...
    static {
        TYPES = new HashMap<Integer, EntityTypes1_10$EntityType>();
        for (EntityTypes1_10$EntityType type : EntityTypes1_10$EntityType.values()) {

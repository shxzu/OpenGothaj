...
public enum EntityTypes1_12$EntityType implements EntityType
{
    ENTITY(-1),
    ...
    private static final Map<Integer, EntityTypes1_12$EntityType> TYPES;
    private final int id;
    private final EntityTypes1_12$EntityType parent;

    private EntityTypes1_12$EntityType(int id) {
        this.id = id;
        this.parent = null;
    }

    private EntityTypes1_12$EntityType(int id, EntityTypes1_12$EntityType parent) {
        this.id = id;
        this.parent = parent;
    }
    ...
    @Override
    public EntityTypes1_12$EntityType getParent() {
        return this.parent;
    }
    ...
    public static Optional<EntityTypes1_12$EntityType> findById(int id) {
        if (id == -1) {
    ...
    static {
        TYPES = new HashMap<Integer, EntityTypes1_12$EntityType>();
        for (EntityTypes1_12$EntityType type : EntityTypes1_12$EntityType.values()) {

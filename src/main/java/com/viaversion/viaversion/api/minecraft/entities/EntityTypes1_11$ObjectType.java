...
public enum EntityTypes1_11$ObjectType implements ObjectType
{
    ...
    private static final Map<Integer, EntityTypes1_11$ObjectType> TYPES;
    private final int id;
    private final EntityTypes1_11.EntityType type;

    private EntityTypes1_11$ObjectType(int id, EntityTypes1_11.EntityType type) {
        this.id = id;
        this.type = type;
    }
    ...
    public static Optional<EntityTypes1_11.EntityType> getPCEntity(int id) {
        Optional<EntityTypes1_11$ObjectType> output = EntityTypes1_11$ObjectType.findById(id);
        if (!output.isPresent()) {
            return Optional.empty();
        }
    ...
    static {
        TYPES = new HashMap<Integer, EntityTypes1_11$ObjectType>();
        for (EntityTypes1_11$ObjectType type : EntityTypes1_11$ObjectType.values()) {

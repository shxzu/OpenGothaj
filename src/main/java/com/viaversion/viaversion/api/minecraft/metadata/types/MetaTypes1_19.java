...
extends AbstractMetaTypes {
    ...
    public final MetaType itemType = this.add(6, Type.ITEM1_13_2);
    ...
    public final MetaType catVariantType = this.add(19, Type.VAR_INT);
    public final MetaType frogVariantType = this.add(20, Type.VAR_INT);
    public final MetaType optionalGlobalPosition = this.add(21, Type.OPTIONAL_GLOBAL_POSITION);
    public final MetaType paintingVariantType = this.add(22, Type.VAR_INT);

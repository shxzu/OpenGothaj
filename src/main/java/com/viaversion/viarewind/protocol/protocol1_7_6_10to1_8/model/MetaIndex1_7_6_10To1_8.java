...
public enum MetaIndex1_7_6_10To1_8 {
    ...
    private static final HashMap<Pair<EntityTypes1_10.EntityType, Integer>, MetaIndex1_7_6_10To1_8> metadataRewrites;
    ...
    private MetaIndex1_7_6_10To1_8(EntityTypes1_10.EntityType type, int index, MetaType1_7_6_10 oldType, MetaType1_8 newType) {
        this.clazz = type;
        this.index = index;
        this.newIndex = index;
    ...
    private MetaIndex1_7_6_10To1_8(EntityTypes1_10.EntityType type, int index, MetaType1_7_6_10 oldType, int newIndex, MetaType1_8 newType) {
        this.clazz = type;
        this.index = index;
        this.oldType = oldType;
    ...
    public static MetaIndex1_7_6_10To1_8 searchIndex(EntityTypes1_10.EntityType type, int index) {
        ...
        do {
            Optional<MetaIndex1_7_6_10To1_8> optMeta;

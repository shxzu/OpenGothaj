...
import xyz.cucumber.base.events.ext.EventSkyColor;
...
implements IResourceManagerReloadListener {
    ...
    public void getMouseOver(float partialTicks) {
        ...
        if (entity != null && this.mc.theWorld != null) {
            ...
            boolean flag = false;
            EventReach event = new EventReach(3.0);
            ...
            if (this.pointedEntity != null && flag && vec3.distanceTo(vec33) > (double)i) {
                this.pointedEntity = null;
    ...
    private void hurtCameraEffect(float partialTicks) {
        if (Client.INSTANCE.getModuleManager().getModule("hurtcam").isEnabled()) {
            return;
        }
        ...
        if (!this.mc.skipRenderWorld) {
            ...
            if (this.mc.theWorld != null) {
                ...
                if (!this.mc.gameSettings.hideGUI || this.mc.currentScreen != null) {
                    ...
                    EventRenderGui event = new EventRenderGui(new ScaledResolution(this.mc));
                    Client.INSTANCE.getEventBus().call(event);
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        EventRender3D event = new EventRender3D(this.mc.timer.renderPartialTicks);
        Client.INSTANCE.getEventBus().call(event);
    ...
    private void updateFogColor(float partialTicks) {
        ...
        Client.INSTANCE.getEventBus().call(event);
        vec31.xCoord = event.getRed() / 255.0f;
        vec31.yCoord = event.getGreen() / 255.0f;
        vec31.zCoord = event.getBlue() / 255.0f;

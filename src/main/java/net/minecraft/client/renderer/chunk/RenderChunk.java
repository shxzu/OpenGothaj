...
public class RenderChunk {
    ...
    public void setPosition(BlockPos pos) {
        ...
        int k = 0;
        while (k < this.renderChunkNeighbours.length) {
    ...
    public void rebuildChunk(float x, float y, float z, ChunkCompileTaskGenerator generator) {
        ...
        if (!this.isChunkRegionEmpty(blockpos)) {
            ...
            for (Object o : BlockPosM.getAllInBoxMutable(blockpos, blockpos1)) {
                ...
                int j = 0;
                while (j < aenumworldblocklayer.length) {
                    boolean flag2;
                    ...
                    if (!flag || (flag2 = Reflector.callBoolean(block, Reflector.ForgeBlock_canRenderInLayer, new Object[]{enumworldblocklayer}))) {
                        ...
                        if (block.getRenderType() != -1) {
                            ...
                            int n = k;
                            aboolean[n] = aboolean[n] | blockrendererdispatcher.renderBlock(iblockstate, blockposm, chunkcacheof, worldrenderer);
            ...
            int n2 = 0;
            while (n2 < n) {
                EnumWorldBlockLayer enumworldblocklayer1 = enumWorldBlockLayerArray[n2];
    ...
    public AabbFrame getBoundingBoxParent() {
        if (this.boundingBoxParent == null) {
            ...
            int j1 = j >> l << l;
            int k1 = k >> l << l;
            if ((i1 != i || j1 != j || k1 != k) && (aabbframe = this.renderGlobal.getRenderChunk(new BlockPos(i1, j1, k1)).getBoundingBoxParent()) != null && aabbframe.minX == (double)i1 && aabbframe.minY == (double)j1 && aabbframe.minZ == (double)k1) {

...
public class RenderGlobal$ContainerLocalRenderInformation {
    ...
    static void access$0(RenderGlobal$ContainerLocalRenderInformation containerLocalRenderInformation, EnumFacing enumFacing, int n) {
        containerLocalRenderInformation.initialize(enumFacing, n);
    }
}

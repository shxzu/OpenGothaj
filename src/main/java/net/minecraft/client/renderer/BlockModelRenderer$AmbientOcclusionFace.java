...
public class BlockModelRenderer$AmbientOcclusionFace {
    ...
    public void updateVertexBrightness(IBlockAccess blockAccessIn, Block blockIn, BlockPos blockPosIn, EnumFacing facingIn, float[] quadBounds, BitSet boundsFlags) {
        ...
        if (boundsFlags.get(1) && blockmodelrenderer$enumneighborinfo.field_178289_i) {
            ...
            this.vertexColorMultiplier[((BlockModelRenderer.VertexTranslations)blockmodelrenderer$vertextranslations).field_178191_g] = f29 * f10 + f30 * f11 + f31 * f12 + f32 * f13;
            this.vertexColorMultiplier[((BlockModelRenderer.VertexTranslations)blockmodelrenderer$vertextranslations).field_178200_h] = f29 * f14 + f30 * f15 + f31 * f16 + f32 * f17;
            this.vertexColorMultiplier[((BlockModelRenderer.VertexTranslations)blockmodelrenderer$vertextranslations).field_178201_i] = f29 * f18 + f30 * f19 + f31 * f20 + f32 * f21;
            this.vertexColorMultiplier[((BlockModelRenderer.VertexTranslations)blockmodelrenderer$vertextranslations).field_178198_j] = f29 * f22 + f30 * f23 + f31 * f24 + f32 * f25;
            ...
            this.vertexBrightness[((BlockModelRenderer.VertexTranslations)blockmodelrenderer$vertextranslations).field_178191_g] = this.getVertexBrightness(i2, j2, k2, l2, f10, f11, f12, f13);
            this.vertexBrightness[((BlockModelRenderer.VertexTranslations)blockmodelrenderer$vertextranslations).field_178200_h] = this.getVertexBrightness(i2, j2, k2, l2, f14, f15, f16, f17);
            this.vertexBrightness[((BlockModelRenderer.VertexTranslations)blockmodelrenderer$vertextranslations).field_178201_i] = this.getVertexBrightness(i2, j2, k2, l2, f18, f19, f20, f21);
            this.vertexBrightness[((BlockModelRenderer.VertexTranslations)blockmodelrenderer$vertextranslations).field_178198_j] = this.getVertexBrightness(i2, j2, k2, l2, f22, f23, f24, f25);
        } else {
            float f6 = (f3 + f + f26 + f5) * 0.25f;
            float f7 = (f2 + f + f4 + f5) * 0.25f;
            float f8 = (f2 + f1 + f27 + f5) * 0.25f;
            float f9 = (f3 + f1 + f28 + f5) * 0.25f;
            this.vertexBrightness[((BlockModelRenderer.VertexTranslations)blockmodelrenderer$vertextranslations).field_178191_g] = this.getAoBrightness(l, i, j1, i3);
            this.vertexBrightness[((BlockModelRenderer.VertexTranslations)blockmodelrenderer$vertextranslations).field_178200_h] = this.getAoBrightness(k, i, i1, i3);
            this.vertexBrightness[((BlockModelRenderer.VertexTranslations)blockmodelrenderer$vertextranslations).field_178201_i] = this.getAoBrightness(k, j, k1, i3);
            this.vertexBrightness[((BlockModelRenderer.VertexTranslations)blockmodelrenderer$vertextranslations).field_178198_j] = this.getAoBrightness(l, j, l1, i3);
            this.vertexColorMultiplier[((BlockModelRenderer.VertexTranslations)blockmodelrenderer$vertextranslations).field_178191_g] = f6;
            this.vertexColorMultiplier[((BlockModelRenderer.VertexTranslations)blockmodelrenderer$vertextranslations).field_178200_h] = f7;
            this.vertexColorMultiplier[((BlockModelRenderer.VertexTranslations)blockmodelrenderer$vertextranslations).field_178201_i] = f8;
            this.vertexColorMultiplier[((BlockModelRenderer.VertexTranslations)blockmodelrenderer$vertextranslations).field_178198_j] = f9;
        }
    }
    ...
    static int[] access$0(BlockModelRenderer$AmbientOcclusionFace ambientOcclusionFace) {
        return ambientOcclusionFace.vertexBrightness;
    }

    static float[] access$1(BlockModelRenderer$AmbientOcclusionFace ambientOcclusionFace) {

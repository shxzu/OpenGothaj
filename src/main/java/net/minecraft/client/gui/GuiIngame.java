...
extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        if (this.recordPlayingUpFor > 0) {
            ...
            if (l1 > 8) {
                ...
                this.getFontRenderer().drawString(this.recordPlaying, -this.getFontRenderer().getStringWidth(this.recordPlaying) / 2, -4.0, l + (l1 << 24 & 0xFF000000));
                GlStateManager.disableBlend();
        ...
        if (this.titlesTimer > 0) {
            ...
            if ((i2 = MathHelper.clamp_int(i2, 0, 255)) > 8) {
                ...
                this.getFontRenderer().drawString(this.displayedTitle, -this.getFontRenderer().getStringWidth(this.displayedTitle) / 2, -10.0, 0xFFFFFF | j2, true);
                GlStateManager.popMatrix();
                GlStateManager.pushMatrix();
                GlStateManager.scale(2.0f, 2.0f, 2.0f);
                this.getFontRenderer().drawString(this.displayedSubTitle, -this.getFontRenderer().getStringWidth(this.displayedSubTitle) / 2, 5.0, 0xFFFFFF | j2, true);
                GlStateManager.popMatrix();
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
            }
    ...
    public void renderDemo(ScaledResolution scaledRes) {
        ...
        this.getFontRenderer().drawStringWithShadow(s, scaledRes.getScaledWidth() - i - 10, 5.0, 0xFFFFFF);
        this.mc.mcProfiler.endSection();
    }
    ...
    private void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes) {
        ...
        if (!event.isCancelled()) {
            ...
            for (Score score : collection) {
                ...
                String s = String.valueOf(ScorePlayerTeam.formatPlayerName(scoreplayerteam, score.getPlayerName())) + ": " + (Object)((Object)EnumChatFormatting.RED) + score.getScorePoints();

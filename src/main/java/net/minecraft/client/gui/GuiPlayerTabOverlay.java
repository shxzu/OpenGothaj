    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn) {
        ...
        while (k4 < l3) {
            ...
            if (k4 < list.size()) {
                ...
                if (mod.isEnabled()) {
                    s1 = s1.replace(this.mc.thePlayer.getName(), mod.getFormatedName());
                }
                ...
                if (flag) {
                    ...
                    int l2 = 8 + (flag1 ? 8 : 0);
                    int i3 = 8 * (flag1 ? -1 : 1);
                    Gui.drawScaledCustomSizeModalRect(j2, k2, 8.0f, l2, 8.0, i3, 8.0, 8.0, 64.0f, 64.0f);
                    if (entityplayer != null && entityplayer.isWearing(EnumPlayerModelParts.HAT)) {
                        int j3 = 8 + (flag1 ? 8 : 0);
                        int k3 = 8 * (flag1 ? -1 : 1);
                        Gui.drawScaledCustomSizeModalRect(j2, k2, 40.0f, j3, 8.0, k3, 8.0, 8.0, 64.0f, 64.0f);
                    }
                    j2 += 9;
                }

...
extends GuiScreen {
    ...
    private void pageInsertIntoCurrent(String p_146459_1_) {
        ...
        int i = this.fontRendererObj.splitStringWidth(String.valueOf(s1) + (Object)((Object)EnumChatFormatting.BLACK) + "_", 118);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.bookGettingSigned) {
            ...
            if (this.bookIsUnsigned) {
                s = this.updateCount / 6 % 2 == 0 ? String.valueOf(s) + (Object)((Object)EnumChatFormatting.BLACK) + "_" : String.valueOf(s) + (Object)((Object)EnumChatFormatting.GRAY) + "_";
            }

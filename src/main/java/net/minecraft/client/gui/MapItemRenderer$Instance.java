...
class MapItemRenderer$Instance {
    ...
    static void access$0(MapItemRenderer$Instance instance) {
        instance.updateMapTexture();
    }

    static void access$1(MapItemRenderer$Instance instance, boolean bl) {
        instance.render(bl);
    }

    static ResourceLocation access$3(MapItemRenderer$Instance instance) {

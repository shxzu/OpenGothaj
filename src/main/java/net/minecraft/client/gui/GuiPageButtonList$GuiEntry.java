...
implements GuiListExtended.IGuiListEntry {
    ...
    static Gui access$0(GuiPageButtonList$GuiEntry guiEntry) {
        return guiEntry.field_178029_b;
    }

    static Gui access$1(GuiPageButtonList$GuiEntry guiEntry) {
        return guiEntry.field_178030_c;
    }

    static Gui access$2(GuiPageButtonList$GuiEntry guiEntry) {

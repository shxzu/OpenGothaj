...
public class ViaLoadingBase {
    ...
    public static final Platform PSEUDO_VIA_VERSION = new Platform("ViaVersion", () -> true, () -> {}, protocolVersions -> {
        boolean bl = protocolVersions.addAll(ViaVersionPlatformImpl.createVersionList());
    });
    public static final Platform PLATFORM_VIA_BACKWARDS = new Platform("ViaBackwards", () -> ViaLoadingBase.inClassPath("com.viaversion.viabackwards.api.ViaBackwardsPlatform"), () -> {
        ViaBackwardsPlatformImpl viaBackwardsPlatformImpl = new ViaBackwardsPlatformImpl(Via.getManager().getPlatform().getDataFolder());
    });
    public static final Platform PLATFORM_VIA_REWIND = new Platform("ViaRewind", () -> ViaLoadingBase.inClassPath("com.viaversion.viarewind.api.ViaRewindPlatform"), () -> {
        ViaRewindPlatformImpl viaRewindPlatformImpl = new ViaRewindPlatformImpl(Via.getManager().getPlatform().getDataFolder());
    });

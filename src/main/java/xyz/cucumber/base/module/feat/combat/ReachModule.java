...
@ModuleInfo(category=Category.COMBAT, description="Allows you hit entity from longer distance", name="Reach", key=0, priority=ArrayPriority.HIGH)
...
extends Mod {
    ...
    public void onReach(EventReach e) {
        EventReach event = e;
        event.setRange(event.getRange() + this.expand.getValue());
    }

...
@ModuleInfo(category=Category.PLAYER, description="Packet editor", name="Custom Disabler")
public class CustomDisablerModule
extends Mod {
    ...
    public CustomDisablerModule() {
        this.addSettings(this.c00, this.c01, this.c02, this.c03, this.c07, this.c08, this.c09, this.c0a, this.c0b, this.c0c, this.c0d, this.c0e, this.c0f, this.c10, this.c11, this.c12, this.c13, this.c14, this.c15, this.c16, this.c17, this.c18, this.c19, this.s00, this.s01, this.s02, this.s03, this.s04, this.s05, this.s06, this.s07, this.s08, this.s09, this.s0a, this.s0b, this.s0c, this.s0d, this.s0e, this.s0f, this.s10, this.s11, this.s12, this.s13, this.s14, this.s18, this.s19, this.s1b, this.s1c, this.s1d, this.s1e, this.s1f, this.s20, this.s21, this.s22, this.s23, this.s24, this.s25, this.s26, this.s27, this.s28, this.s29, this.s2a, this.s2b, this.s2c, this.s2d, this.s2e, this.s2f, this.s30, this.s31, this.s32, this.s33, this.s34, this.s35, this.s36, this.s37, this.s38, this.s39, this.s3a, this.s3b, this.s3c, this.s3d, this.s3e, this.s3f, this.s40, this.s41, this.s42, this.s43, this.s44, this.s45);
    }

    @EventListener
    public void onSendPacket(EventSendPacket event) {
        Packet packet = event.getPacket();
        if (packet instanceof C00PacketKeepAlive && this.c00.isEnabled() || packet instanceof C01PacketChatMessage && this.c01.isEnabled() || packet instanceof C02PacketUseEntity && this.c02.isEnabled() || packet instanceof C03PacketPlayer && this.c03.isEnabled() || packet instanceof C07PacketPlayerDigging && this.c07.isEnabled() || packet instanceof C08PacketPlayerBlockPlacement && this.c08.isEnabled() || packet instanceof C09PacketHeldItemChange && this.c09.isEnabled() || packet instanceof C0APacketAnimation && this.c0a.isEnabled() || packet instanceof C0BPacketEntityAction && this.c0b.isEnabled() || packet instanceof C0CPacketInput && this.c0c.isEnabled() || packet instanceof C0DPacketCloseWindow && this.c0d.isEnabled() || packet instanceof C0EPacketClickWindow && this.c0e.isEnabled() || packet instanceof C0FPacketConfirmTransaction && this.c0f.isEnabled() || packet instanceof C10PacketCreativeInventoryAction && this.c10.isEnabled() || packet instanceof C11PacketEnchantItem && this.c11.isEnabled() || packet instanceof C12PacketUpdateSign && this.c12.isEnabled() || packet instanceof C13PacketPlayerAbilities && this.c13.isEnabled() || packet instanceof C14PacketTabComplete && this.c14.isEnabled() || packet instanceof C15PacketClientSettings && this.c15.isEnabled() || packet instanceof C16PacketClientStatus && this.c16.isEnabled() || packet instanceof C17PacketCustomPayload && this.c17.isEnabled() || packet instanceof C18PacketSpectate && this.c18.isEnabled() || packet instanceof C19PacketResourcePackStatus && this.c19.isEnabled()) {
    ...
    public void onReceivePacket(EventReceivePacket event) {
        Packet packet = event.getPacket();
        if (packet instanceof S00PacketKeepAlive && this.s00.isEnabled() || packet instanceof S01PacketJoinGame && this.s01.isEnabled() || packet instanceof S02PacketChat && this.s02.isEnabled() || packet instanceof S03PacketTimeUpdate && this.s03.isEnabled() || packet instanceof S04PacketEntityEquipment && this.s04.isEnabled() || packet instanceof S05PacketSpawnPosition && this.s05.isEnabled() || packet instanceof S06PacketUpdateHealth && this.s06.isEnabled() || packet instanceof S07PacketRespawn && this.s07.isEnabled() || packet instanceof S08PacketPlayerPosLook && this.s08.isEnabled() || packet instanceof S09PacketHeldItemChange && this.s09.isEnabled() || packet instanceof S0APacketUseBed && this.s0a.isEnabled() || packet instanceof S0BPacketAnimation && this.s0b.isEnabled() || packet instanceof S0CPacketSpawnPlayer && this.s0c.isEnabled() || packet instanceof S0DPacketCollectItem && this.s0d.isEnabled() || packet instanceof S0EPacketSpawnObject && this.s0e.isEnabled() || packet instanceof S0FPacketSpawnMob && this.s0f.isEnabled() || packet instanceof S10PacketSpawnPainting && this.s10.isEnabled() || packet instanceof S11PacketSpawnExperienceOrb && this.s11.isEnabled() || packet instanceof S12PacketEntityVelocity && this.s12.isEnabled() || packet instanceof S13PacketDestroyEntities && this.s13.isEnabled() || packet instanceof S14PacketEntity && this.s14.isEnabled() || packet instanceof S18PacketEntityTeleport && this.s18.isEnabled() || packet instanceof S19PacketEntityHeadLook && this.s19.isEnabled() || packet instanceof S1BPacketEntityAttach && this.s1b.isEnabled() || packet instanceof S1CPacketEntityMetadata && this.s1c.isEnabled() || packet instanceof S1DPacketEntityEffect && this.s1d.isEnabled() || packet instanceof S1EPacketRemoveEntityEffect && this.s1e.isEnabled() || packet instanceof S1FPacketSetExperience && this.s1f.isEnabled() || packet instanceof S20PacketEntityProperties && this.s20.isEnabled() || packet instanceof S21PacketChunkData && this.s21.isEnabled() || packet instanceof S22PacketMultiBlockChange && this.s22.isEnabled() || packet instanceof S23PacketBlockChange && this.s23.isEnabled() || packet instanceof S24PacketBlockAction && this.s24.isEnabled() || packet instanceof S25PacketBlockBreakAnim && this.s25.isEnabled() || packet instanceof S26PacketMapChunkBulk && this.s26.isEnabled() || packet instanceof S27PacketExplosion && this.s27.isEnabled() || packet instanceof S28PacketEffect && this.s28.isEnabled() || packet instanceof S29PacketSoundEffect && this.s29.isEnabled() || packet instanceof S2APacketParticles && this.s2a.isEnabled() || packet instanceof S2BPacketChangeGameState && this.s2b.isEnabled() || packet instanceof S2CPacketSpawnGlobalEntity && this.s2c.isEnabled() || packet instanceof S2DPacketOpenWindow && this.s2d.isEnabled() || packet instanceof S2EPacketCloseWindow && this.s2e.isEnabled() || packet instanceof S2FPacketSetSlot && this.s2f.isEnabled() || packet instanceof S30PacketWindowItems && this.s30.isEnabled() || packet instanceof S31PacketWindowProperty && this.s31.isEnabled() || packet instanceof S32PacketConfirmTransaction && this.s32.isEnabled() || packet instanceof S33PacketUpdateSign && this.s33.isEnabled() || packet instanceof S34PacketMaps && this.s34.isEnabled() || packet instanceof S35PacketUpdateTileEntity && this.s35.isEnabled() || packet instanceof S36PacketSignEditorOpen && this.s36.isEnabled() || packet instanceof S37PacketStatistics && this.s37.isEnabled() || packet instanceof S38PacketPlayerListItem && this.s38.isEnabled() || packet instanceof S39PacketPlayerAbilities && this.s39.isEnabled() || packet instanceof S3APacketTabComplete && this.s3a.isEnabled() || packet instanceof S3BPacketScoreboardObjective && this.s3b.isEnabled() || packet instanceof S3CPacketUpdateScore && this.s3c.isEnabled() || packet instanceof S3DPacketDisplayScoreboard && this.s3d.isEnabled() || packet instanceof S3EPacketTeams && this.s3e.isEnabled() || packet instanceof S3FPacketCustomPayload && this.s3f.isEnabled() || packet instanceof S40PacketDisconnect && this.s40.isEnabled() || packet instanceof S41PacketServerDifficulty && this.s41.isEnabled() || packet instanceof S42PacketCombatEvent && this.s42.isEnabled() || packet instanceof S43PacketCamera && this.s43.isEnabled() || packet instanceof S44PacketWorldBorder && this.s44.isEnabled() || packet instanceof S45PacketTitle && this.s45.isEnabled()) {
            event.setCancelled(true);
        }
    }
}

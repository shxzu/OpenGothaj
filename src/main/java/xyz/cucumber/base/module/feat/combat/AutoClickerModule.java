...
@ModuleInfo(category=Category.COMBAT, description="Automatically click for you", name="Auto Clicker", key=0, priority=ArrayPriority.HIGH)
...
extends Mod {
    ...
    public AutoClickerModule() {
        this.addSettings(this.left, this.right, this.minLeftCps, this.maxLeftCps, this.minRightCps, this.maxRightCps, this.instantRightClick, this.onlyBlock);
    }
    ...
    public void onTick(EventTick e) {
        ...
        if (this.shouldRightClick && this.right.isEnabled()) {
            ...
            if (this.onlyBlock.isEnabled()) {
                if (this.mc.thePlayer.getHeldItem() != null && this.mc.thePlayer.getHeldItem().getItem() != null && this.mc.thePlayer.getHeldItem().getItem() instanceof ItemBlock && this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && this.mc.objectMouseOver.getBlockPos() != null) {
    ...
    public void onGameLoop(EventGameLoop e) {
        ...
        if (this.mc.gameSettings.keyBindAttack.pressed && this.leftTimer.hasTimeElapsed(finalLeftDelay -= 5.0, true)) {
        ...
        if (this.mc.gameSettings.keyBindUseItem.pressed && this.rightTimer.hasTimeElapsed(finalRightDelay -= 5.0, true)) {

...
extends Mod {
    ...
    public StealerModule() {
        this.addSettings(this.startDelay, this.minDelay, this.maxDelay, this.stealTrashItems, this.autoClose, this.chestName, this.disableOnWorldChange);
    }
    ...
    public void onMotion(EventMotion e) {
        ...
        if (this.mc.currentScreen instanceof GuiChest && Display.isVisible() && (!this.chestName.isEnabled() || ((GuiChest)this.mc.currentScreen).lowerChestInventory.getDisplayName().getUnformattedText().contains("chest"))) {
    ...
    public void onRenderGui(EventUpdate e) {
        ...
        if (this.mc.currentScreen instanceof GuiChest) {
            String name;
            if (this.chestName.isEnabled() && !(name = ((GuiChest)this.mc.currentScreen).lowerChestInventory.getDisplayName().getUnformattedText()).toLowerCase().contains("chest")) {
                return;
            }

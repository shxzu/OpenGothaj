...
@ModuleInfo(category=Category.OTHER, description="Attacks only allowed players", name="Reverse Friends", priority=ArrayPriority.LOW)
public class ReverseFriendsModule
extends Mod {

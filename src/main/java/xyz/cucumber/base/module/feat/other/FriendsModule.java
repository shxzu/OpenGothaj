...
@ModuleInfo(category=Category.OTHER, description="Disallows to attack friends", name="Friends", priority=ArrayPriority.LOW)
...
extends Mod {
    ...
    public FriendsModule() {
        this.addSettings(this.midClickAdd, this.range);
    }

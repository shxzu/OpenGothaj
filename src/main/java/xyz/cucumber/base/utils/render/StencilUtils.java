...
public class StencilUtils {
    ...
    public static void setupFBO(Framebuffer framebuffer) {
        ...
        EXTFramebufferObject.glRenderbufferStorageEXT((int)36161, (int)34041, (int)StencilUtils.mc.displayWidth, (int)StencilUtils.mc.displayHeight);
    ...
    public static void initStencil() {
        StencilUtils.initStencil(mc.getFramebuffer());
    }

    public static void initStencil(Framebuffer framebuffer) {
        framebuffer.bindFramebuffer(false);
        StencilUtils.checkSetupFBO(framebuffer);
        GL11.glClear((int)1024);
        GL11.glEnable((int)2960);
    }

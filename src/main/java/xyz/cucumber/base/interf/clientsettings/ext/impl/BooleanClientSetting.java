...
public class BooleanClientSetting
extends ClientSetting {
    ...
    public void draw(int mouseX, int mouseY) {
        ...
        Fonts.getFont("rb-m").drawString(this.setting.getName(), this.position.getX() + 8.0, this.position.getY() + this.position.getHeight() / 2.0 - (double)(Fonts.getFont("rb-m").getHeight("H") / 2.0f), -1);
        RenderUtils.drawRoundedRect(this.button.getX(), this.button.getY(), this.button.getX2(), this.button.getY2(), -1867863382, 4.0f);
        this.animation = this.setting.isEnabled() ? (this.animation * 9.0 + 10.0) / 10.0 : this.animation * 9.0 / 10.0;
        RenderUtils.drawCircle(this.button.getX() + 5.0 + this.animation, this.button.getY() + 5.0, 4.5, 0x25FFFFFF, 2.0);
        RenderUtils.drawCircle(this.button.getX() + 5.0 + this.animation, this.button.getY() + 5.0, 5.5, 0x25FFFFFF, 2.0);
        RenderUtils.drawCircle(this.button.getX() + 5.0 + this.animation, this.button.getY() + 5.0, 6.5, 0x25FFFFFF, 2.0);

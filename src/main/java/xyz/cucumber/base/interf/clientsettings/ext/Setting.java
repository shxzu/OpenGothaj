...
public abstract class Setting {
    ...
    public void draw(int mouseX, int mouseY) {
        ...
        GL11.glPushMatrix();
        GL11.glTranslated((double)(this.position.getX() + this.position.getWidth() / 2.0 - Fonts.getFont("rb-b").getWidth(this.name) * 1.1 / 2.0), (double)5.0, (double)0.0);
        GL11.glScaled((double)1.1, (double)1.1, (double)1.0);
        Fonts.getFont("rb-b").drawString(this.name, 0.0, this.position.getY() - 12.5, -1);
        GL11.glScaled((double)1.0, (double)1.0, (double)1.0);
        GL11.glPopMatrix();
        RenderUtils.drawLine(this.position.getX() + 7.0, this.position.getY() + 17.0, this.position.getX2() - 7.0, this.position.getY() + 17.0, 0x40777777, 2.0f);

...
extends SettingsButton {
    ...
    public void draw(int mouseX, int mouseY) {
        this.animation = this.setting.isEnabled() ? (this.animation * 15.0 + 5.0) / 16.0 : this.animation * 15.0 / 16.0;
        ...
        RenderUtils.drawRoundedRect(this.checkBox.getX() + this.checkBox.getWidth() / 2.0 - this.animation, this.checkBox.getY() + this.checkBox.getHeight() / 2.0 - this.animation, this.checkBox.getX() + this.checkBox.getWidth() / 2.0 + this.animation, this.checkBox.getY() + this.checkBox.getHeight() / 2.0 + this.animation, -12424715, 2.0f);
        if (this.setting.isEnabled()) {
            RenderUtils.drawImage(this.checkBox.getX() + this.checkBox.getWidth() / 2.0 - 3.0, this.checkBox.getY() + this.checkBox.getHeight() / 2.0 - 3.0 + 0.5, 6.0, 6.0, new ResourceLocation("client/images/check.png"), -1);
        }
    }

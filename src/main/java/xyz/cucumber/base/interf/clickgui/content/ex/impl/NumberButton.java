...
extends SettingsButton {
    ...
    public void draw(int mouseX, int mouseY) {
        Fonts.getFont("rb-r").drawString(this.setting.getName(), (float)(this.position.getX() + 8.0), (float)(this.position.getY() + 3.0), -1);
        ...
        RenderUtils.drawRect(this.slider.getX(), this.slider.getY(), this.slider.getX2(), this.slider.getY2(), 0x30000000);
        RenderUtils.drawOutlinedRect(this.slider.getX(), this.slider.getY(), this.slider.getX2(), this.slider.getY2(), -1874695691, 1.0f);
        double x = this.slider.getX() + 2.0 + (this.slider.getWidth() - 4.0) * (this.setting.getValue() - this.setting.getMin()) / (this.setting.getMax() - this.setting.getMin());
        RenderUtils.drawRect(x - 2.0, this.slider.getY(), x + 2.0, this.slider.getY2(), 1078094325);
        Fonts.getFont("rb-r").drawString(String.valueOf(this.setting.getValue()), (float)(this.slider.getX() + this.slider.getWidth() / 2.0 - Fonts.getFont("rb-r").getWidth(String.valueOf(this.setting.getValue())) / 2.0), (float)this.slider.getY() + 2.5f, -12424715);
    }

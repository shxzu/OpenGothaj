...
extends SettingsButton {
    ...
    public void draw(int mouseX, int mouseY) {
        ...
        RenderUtils.drawRoundedRect((double)this.textField.xPosition, (double)this.textField.yPosition, (double)(this.textField.xPosition + this.textField.width), (double)(this.textField.yPosition + this.textField.height), -15132391, 1.0f);
        this.animation = this.textField.isFocused() ? (this.animation * 9.0 + (double)(this.textField.width / 2) - 3.0) / 10.0 : this.animation * 9.0 / 10.0;
        RenderUtils.drawLine((double)(this.textField.xPosition + this.textField.width / 2) - this.animation, this.textField.yPosition + this.textField.height - 1, (double)(this.textField.xPosition + this.textField.width / 2) + this.animation, this.textField.yPosition + this.textField.height - 1, -12424715, 1.0f);
        ...
        Fonts.getFont("rb-r").drawString(render, (double)(this.textField.xPosition + this.textField.width / 2) - Fonts.getFont("rb-r").getWidth(render) / 2.0, (float)(this.textField.yPosition + this.textField.height / 2) - Fonts.getFont("rb-r").getHeight(render) / 2.0f, -5592406);

...
public class ModuleToggleButton
extends SettingsButton {
    ...
    public void draw(int mouseX, int mouseY) {
        int color = -1;
        this.toggleAnimation = this.module.isEnabled() ? (this.toggleAnimation * 9.0 + this.toggleButton.getWidth() - 10.0) / 10.0 : this.toggleAnimation * 9.0 / 10.0;
        ...
        Fonts.getFont("rb-r").drawString(this.module.getDescription(), this.position.getX() + this.position.getWidth() / 2.0 - Fonts.getFont("rb-r").getWidth(this.module.getDescription()) / 2.0, this.position.getY() + 4.0, -5592406);
        this.toggleButton.setX(this.position.getX2() - this.toggleButton.getWidth() - 2.5);
        this.toggleButton.setY(this.position.getY() + 2.5);
        RenderUtils.drawRoundedRect(this.toggleButton.getX(), this.toggleButton.getY(), this.toggleButton.getX2(), this.toggleButton.getY2(), ColorUtils.mix(-13421773, -12424715, this.toggleAnimation, this.toggleButton.getWidth() - 10.0), 4.0f);
        RenderUtils.drawCircle(this.toggleButton.getX() + 4.0 + 1.0 + this.toggleAnimation, this.toggleButton.getY() + this.toggleButton.getHeight() / 2.0, 4.0, -1, 1.0);
    }

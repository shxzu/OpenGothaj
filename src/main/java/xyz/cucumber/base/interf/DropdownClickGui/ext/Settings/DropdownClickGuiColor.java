...
public class DropdownClickGuiColor
extends DropdownClickGuiSettings {
    ...
    public DropdownClickGuiColor(ModuleSettings setting, PositionUtils positionUtils) {
        ...
        this.h1 = Color.RGBtoHSB(c.getRed(), c.getGreen(), c.getBlue(), null)[0];
        Color c1 = new Color(this.setting.getSecondaryColor());
        this.h2 = Color.RGBtoHSB(c1.getRed(), c1.getGreen(), c1.getBlue(), null)[0];
    ...
    public void draw(int mouseX, int mouseY) {
        ...
        RenderUtils.drawMixedRoundedRect(this.position.getX2() - 20.0, this.position.getY() + 2.0, this.position.getX2() - 5.0, this.position.getY() + this.defaultheight - 2.0, this.setting.getMainColor(), this.setting.getSecondaryColor(), 2.0);
        if (this.open) {
            double newValueY;
            double newValueX;
            double diffY;
            ...
            GL11.glVertex2d((double)this.alpha.getX(), (double)this.alpha.getY());
            RenderUtils.color(0xFF0000);
            GL11.glVertex2d((double)this.alpha.getX2(), (double)this.alpha.getY());
            GL11.glVertex2d((double)this.alpha.getX2(), (double)this.alpha.getY2());
            RenderUtils.color(-65536);
            GL11.glVertex2d((double)this.alpha.getX(), (double)this.alpha.getY2());
            GL11.glEnd();
            RenderUtils.stop2D();
            ...
            RenderUtils.drawRoundedRect(this.color1Point.getX() - 0.5, this.color1Point.getY() - 0.5, this.color1Point.getX2() + 0.5, this.color1Point.getY2() + 0.5, -1, 1.0f);
            ...
            RenderUtils.drawRoundedRect(this.hue1Point.getX() - 1.0, this.hue1Point.getY() - 1.0, this.hue1Point.getX2() + 1.0, this.hue1Point.getY2() + 1.0, -1, 1.0f);
            RenderUtils.drawRoundedRect(this.hue1Point.getX() - 0.5, this.hue1Point.getY() - 0.5, this.hue1Point.getX2() + 0.5, this.hue1Point.getY2() + 0.5, Color.HSBtoRGB((float)this.h2, 1.0f, 1.0f), 1.0f);
            ...
            RenderUtils.drawRoundedRect(this.color2Point.getX() - 0.5, this.color2Point.getY() - 0.5, this.color2Point.getX2() + 0.5, this.color2Point.getY2() + 0.5, -1, 1.0f);
            ...
            RenderUtils.drawRoundedRect(this.hue2Point.getX() - 1.0, this.hue2Point.getY() - 1.0, this.hue2Point.getX2() + 1.0, this.hue2Point.getY2() + 1.0, -1, 1.0f);
            RenderUtils.drawRoundedRect(this.hue2Point.getX() - 0.5, this.hue2Point.getY() - 0.5, this.hue2Point.getX2() + 0.5, this.hue2Point.getY2() + 0.5, Color.HSBtoRGB((float)this.h2, 1.0f, 1.0f), 1.0f);
            if (this.dragging) {
                diff = Math.min(this.hue1.getWidth(), Math.max(0.0, (double)mouseX - this.hue1.getX()));
                newValue = this.roundToPlace(diff / this.hue1.getWidth() * 1.0, (int)this.hue1.getWidth());
                this.h1 = (float)newValue;
            }
            if (this.draggingHue2) {
                diff = Math.min(this.hue2.getWidth(), Math.max(0.0, (double)mouseX - this.hue2.getX()));
                newValue = this.roundToPlace(diff / this.hue2.getWidth() * 1.0, (int)this.hue2.getWidth());
                this.h2 = (float)newValue;
            }
            if (this.draggingAlpha) {
                diff = Math.min(this.alpha.getWidth(), Math.max(0.0, (double)mouseX - this.alpha.getX()));
                newValue = this.roundToPlace(diff / this.alpha.getWidth() * 100.0, (int)this.alpha.getWidth());
                this.setting.setAlpha(100 - (int)Math.round(newValue));
            }
            if (this.draggingColor1) {
                diffX = Math.min(this.color1.getWidth(), Math.max(0.0, (double)mouseX - this.color1.getX()));
                diffY = Math.min(this.color1.getHeight(), Math.max(0.0, (double)mouseY - this.color1.getY()));
                newValueX = this.roundToPlace(diffX / this.color1.getWidth() * 1.0, (int)this.color1.getWidth());
                newValueY = this.roundToPlace(diffY / this.color1.getHeight() * 1.0, (int)this.color1.getHeight());
            ...
            if (this.draggingColor2) {
                diffX = Math.min(this.color2.getWidth(), Math.max(0.0, (double)mouseX - this.color2.getX()));
                diffY = Math.min(this.color2.getHeight(), Math.max(0.0, (double)mouseY - this.color2.getY()));
                newValueX = this.roundToPlace(diffX / this.color2.getWidth() * 1.0, (int)this.color2.getWidth());
                newValueY = this.roundToPlace(diffY / this.color2.getHeight() * 1.0, (int)this.color2.getHeight());
            ...
            RenderUtils.drawRoundedRect(this.alpha.getX() - 3.0 + (-((double)this.setting.getAlpha() * this.alpha.getWidth()) / 100.0 + this.alpha.getWidth()), this.alpha.getY() - 1.0, this.alpha.getX() + 3.0 + (-((double)this.setting.getAlpha() * this.alpha.getWidth()) / 100.0 + this.alpha.getWidth()), this.alpha.getY2() + 1.0, -5592406, 2.0f);
            RenderUtils.drawRoundedRect(this.alpha.getX() - 2.5 + (-((double)this.setting.getAlpha() * this.alpha.getWidth()) / 100.0 + this.alpha.getWidth()), this.alpha.getY() - 0.5, this.alpha.getX() + 2.5 + (-((double)this.setting.getAlpha() * this.alpha.getWidth()) / 100.0 + this.alpha.getWidth()), this.alpha.getY2() + 0.5, -1, 2.0f);
            ...
            RenderUtils.drawRoundedRectWithCorners(this.mode.getX() + Fonts.getFont("rb-m-13").getWidth("Mode") + 5.0 - 1.0 + 4.0, this.mode.getY() + this.mode.getHeight() / 2.0 - 4.0, this.mode.getX() + 4.0 + Fonts.getFont("rb-m-13").getWidth("Mode") + 6.0 + Fonts.getFont("rb-m-13").getWidth(this.setting.getMode()), this.mode.getY() + this.mode.getHeight() / 2.0 + 4.0, -13354432, 2.0, true, true, true, true);
            Fonts.getFont("rb-m-13").drawString(this.setting.getMode(), this.mode.getX() + 4.0 + Fonts.getFont("rb-m-13").getWidth("Mode") + 5.5, this.mode.getY() + 3.0, -1);
        } else {

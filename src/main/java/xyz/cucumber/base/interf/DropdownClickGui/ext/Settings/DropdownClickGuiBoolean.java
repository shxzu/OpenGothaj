...
public class DropdownClickGuiBoolean
extends DropdownClickGuiSettings {
    ...
    public void draw(int mouseX, int mouseY) {
        ...
        RenderUtils.drawRoundedRectWithCorners(this.checkMark.getX(), this.checkMark.getY(), this.checkMark.getX2(), this.checkMark.getY2(), 0x30000000, 4.0, true, true, true, true);
        RenderUtils.drawRoundedRectWithCorners(this.checkMark.getX() + this.checkMark.getWidth() / 2.0 - this.animation, this.checkMark.getY() + this.checkMark.getHeight() / 2.0 - this.animation, this.checkMark.getX() + this.checkMark.getWidth() / 2.0 + this.animation, this.checkMark.getY() + this.checkMark.getHeight() / 2.0 + this.animation, -13354432, 4.0 / (this.checkMark.getWidth() / 2.0) * this.animation, true, true, true, true);

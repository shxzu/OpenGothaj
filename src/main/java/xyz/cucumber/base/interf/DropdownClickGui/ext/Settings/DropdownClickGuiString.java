...
public class DropdownClickGuiString
extends DropdownClickGuiSettings {
    ...
    public void draw(int mouseX, int mouseY) {
        ...
        Fonts.getFont("rb-m-13").drawString(this.setting.getName(), this.position.getX() + 3.0, this.field.yPosition + 3, -1);
        ...
        Fonts.getFont("rb-r-13").drawString(this.setting.getString(), this.field.xPosition, this.field.yPosition + 3, -1);
    }

...
public class DropdownClickGuiNumber
extends DropdownClickGuiSettings {
    ...
    public void draw(int mouseX, int mouseY) {
        ...
        Fonts.getFont("rb-m-13").drawString(String.valueOf(this.setting.getValue()), this.position.getX2() - 5.0 - Fonts.getFont("rb-m-13").getWidth(String.valueOf(this.setting.getValue())), this.position.getY() + 1.0, -5592406);
        ...
        RenderUtils.drawCircle(this.slider.getX() + this.animation, this.slider.getY() + this.slider.getHeight() / 2.0, this.collideCircle.getHeight() / 2.0, -7706881, 1.0);
    }

...
public class NewBooleanSetting
extends NewSetting {
    ...
    public void draw(int mouseX, int mouseY) {
        ...
        Fonts.getFont("rb-m").drawString(this.setting.getName(), this.position.getX() + 12.0, this.position.getY() + 5.0, ColorUtils.mix(-5592406, -1, this.animation, 1.0));
        this.button.setX(this.position.getX2() - 32.0);
        this.button.setY(this.position.getY() + 1.0);
        RenderUtils.drawRoundedRect(this.button.getX(), this.button.getY(), this.button.getX2(), this.button.getY2(), ColorUtils.mix(-16185079, -881934, this.animation, 1.0), 4.0f);
        RenderUtils.drawCircle(this.button.getX() + this.button.getWidth() / 4.0 + this.animation * this.button.getWidth() / 2.1, this.button.getY() + this.button.getWidth() / 4.0, this.button.getWidth() / 4.5, -1, 2.0);
    }

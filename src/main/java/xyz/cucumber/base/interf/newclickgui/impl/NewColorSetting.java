...
extends NewSetting {
    ...
    public void draw(int mouseX, int mouseY) {
        ...
        RoundedUtils.drawGradientRectSideways(this.position.getX2() - 32.0, this.position.getY() + 2.0, 15.0, 8.0, this.set.getMainColor(), this.set.getSecondaryColor(), 2.0f);
        if (this.open) {
            double newValueY;
            double newValueX;
            double diffY;
            ...
            RenderUtils.drawRoundedRect(this.hue1Point.getX() - 0.5, this.hue1Point.getY() - 0.5, this.hue1Point.getX2() + 0.5, this.hue1Point.getY2() + 0.5, Color.HSBtoRGB((float)this.h1, 1.0f, 1.0f), 1.0f);
            ...
            RenderUtils.drawRoundedRect(this.alpha.getX() - 3.0 + (-((double)this.set.getAlpha() * this.alpha.getWidth()) / 100.0 + this.alpha.getWidth()), this.alpha.getY() - 1.0, this.alpha.getX() + 3.0 + (-((double)this.set.getAlpha() * this.alpha.getWidth()) / 100.0 + this.alpha.getWidth()), this.alpha.getY2() + 1.0, -5592406, 2.0f);
            RenderUtils.drawRoundedRect(this.alpha.getX() - 2.5 + (-((double)this.set.getAlpha() * this.alpha.getWidth()) / 100.0 + this.alpha.getWidth()), this.alpha.getY() - 0.5, this.alpha.getX() + 2.5 + (-((double)this.set.getAlpha() * this.alpha.getWidth()) / 100.0 + this.alpha.getWidth()), this.alpha.getY2() + 0.5, -1, 2.0f);
            ...
            RenderUtils.drawRoundedRect(this.mode.getX() + Fonts.getFont("rb-m-13").getWidth("Mode") + 5.0 - 1.0 + 4.0 - 1.0, this.mode.getY() + this.mode.getHeight() / 2.0 - 4.0 - 1.0, this.mode.getX() + 4.0 + Fonts.getFont("rb-m-13").getWidth("Mode") + 6.0 + Fonts.getFont("rb-m-13").getWidth(this.set.getMode()) + 1.0, this.mode.getY() + this.mode.getHeight() / 2.0 + 3.0 + 1.0, -881934, 1.0f);
            Fonts.getFont("rb-m-13").drawString(this.set.getMode(), this.mode.getX() + 4.0 + Fonts.getFont("rb-m-13").getWidth("Mode") + 5.5, this.mode.getY() + 3.0, -1);
            return;
        }
